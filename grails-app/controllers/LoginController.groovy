...
class LoginController {
    ...
    def auth = {
        ...
        //def DelegatingDataSource= new DelegatingDataSource()
        //dataSource.setCredentialsForCurrentThread("shawpon@localhost", "12345678")
        ...
        if (params.userName) {
            ...
            if (user && user.email) {
                ...
                if (!user.save(flush: true)) {
                    ...
                    flash.message = message(code: "msg.forgotPassword.reset.error")
