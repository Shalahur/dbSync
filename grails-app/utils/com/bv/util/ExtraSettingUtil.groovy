    ...
    public List wrapPaymentTermInGrid(List<GroovyRowResult>paymentTermList,int start){
        ...
        try{
            ...
            for (int i = 0; i <paymentTermList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(paymentTerm.status)
                ...
                obj.cell=["terms":paymentTerm.terms,"daysBeforeDue":paymentTerm.daysBeforeDue,"alertStartDays":paymentTerm.alertStartDays,"alertRepeatDays":paymentTerm.alertRepeatDays,"status":status,"action":changeBooking]
...
//        result.add(incomeEntries);
    ...
    public List wrapFiscalYearInGrid(List<GroovyRowResult>fiscalYearList,int start){
        ...
        try{
            ...
            for (int i = 0; i <fiscalYearList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(fiscalYear.status)
    ...
    public List wrapBankAccountTypeInGrid(List<GroovyRowResult>bankAccountTypeList,int start){
        ...
        try{
            ...
            for (int i = 0; i <bankAccountTypeList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(bankAccountType.status)
                changeBooking = "<a href='javascript:changeBooking(\"${bankAccountType.id}\")'><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
    ...
    public List wrapCompanyBankAccountInGrid(List<GroovyRowResult>companyBankAccountList,int start){
        ...
        try{
            ...
            for (int i = 0; i <companyBankAccountList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(companyBankAccount.status)
                changeBooking = "<a href='javascript:changeBooking(\"${companyBankAccount.id}\")'><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
                obj.cell=["bankAccountName":companyBankAccount.bankAccountName,"iban":companyBankAccount.iban,"bankAccountNo":companyBankAccount.bankAccountNo,"bankAccountType":companyBankAccount.bankAccountType,"status":status,"action":changeBooking]
    ...
    public List wrapExchangeRateInGrid(List<GroovyRowResult>exchangeRateList,int start){
        ...
        try{
            ...
            for (int i = 0; i <exchangeRateList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(exchangeRate.status)
    ...
    public List wrapVatCategoryInGrid(List<GroovyRowResult>vatCategoryList,int start){
        ...
        try{
            ...
            for (int i = 0; i <vatCategoryList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(vatCategory.status)
                def salesGlAccountDetails = new CoreParamsHelper().getChartMasterInformationByCode(vatCategory.salesGlAccount)
                salesGlAccountDetails=salesGlAccountDetails[0]+"-"+salesGlAccountDetails[1]
                def purchaseGlAccountDetails = new CoreParamsHelper().getChartMasterInformationByCode(vatCategory.purchaseGlAccount)
                purchaseGlAccountDetails=purchaseGlAccountDetails[0]+"-"+purchaseGlAccountDetails[1]
                changeBooking = "<a href='/vatCategory/list?id=${vatCategory.id} '><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
    ...
    public List wrapReconciliationBookingTypeInGrid(List<GroovyRowResult>reconciliationBookingTypeList,int start){
        ...
        try{
            ...
            for (int i = 0; i <reconciliationBookingTypeList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(reconciliationBookingType.status)
                def glAccountDetails = new CoreParamsHelper().getChartMasterInformationByCode(reconciliationBookingType.glAccount)
                glAccountDetails=glAccountDetails[0]+" "+glAccountDetails[1]

                changeBooking = "<a href='/reconciliationBookingType/list?id=${reconciliationBookingType.id} '><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
    ...
    public List wrapDebitCreditGlSetupInGrid(List<GroovyRowResult>debitCreditGlSetupList,int start){
        ...
        try{
            ...
            for (int i = 0; i <debitCreditGlSetupList.size() ; i++){
                ...
                def debtorGlCodeDetails = new CoreParamsHelper().getChartMasterInformationByCode(debitCreditGlSetup.debitorGlCode)
                debtorGlCodeDetails=debtorGlCodeDetails[0]+" "+debtorGlCodeDetails[1]
                def creditorGlCodeDetails = new CoreParamsHelper().getChartMasterInformationByCode(debitCreditGlSetup.creditorGlCode)
                creditorGlCodeDetails=creditorGlCodeDetails[0]+" "+creditorGlCodeDetails[1]
                def reconciliationGlCodeDetails = new CoreParamsHelper().getChartMasterInformationByCode(debitCreditGlSetup.reconcilationGlCode)
                reconciliationGlCodeDetails=reconciliationGlCodeDetails[0]+" "+reconciliationGlCodeDetails[1]

                changeBooking = "<a href='/debitCreditGlSetup/edit?id=${debitCreditGlSetup.id} '><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
    ...
    public List wrapCompanyBankGlRelationInGrid(List<GroovyRowResult>companyBankGlRelationList,int start){
        ...
        try{
            ...
            for (int i = 0; i <companyBankGlRelationList.size() ; i++){
                ...
                def bankAccountCodeDetails = new CoreParamsHelper().getCompanyBankAccInformationByCode(companyBankGlRelation.bankAccountCode)
                bankAccountCodeDetails=bankAccountCodeDetails[0]+"-"+bankAccountCodeDetails[1]
                def glChartCodeDetails = new CoreParamsHelper().getChartMasterInformationByCode(companyBankGlRelation.glChartCode)
                glChartCodeDetails=glChartCodeDetails[0]+"-"+glChartCodeDetails[1]
                def status=new CoreParamsHelper().ShowStatus(companyBankGlRelation.status)
                changeBooking = "<a href='javascript:changeBooking(\"${companyBankGlRelation.id}\")'><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
    ...
    public List wrapProductCategoryInGrid(List<GroovyRowResult>productCategoryList,int start){
        ...
        try{
            ...
            for (int i = 0; i <productCategoryList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(productCategory.status)
    ...
    public List wrapProductMasterInGrid(List<GroovyRowResult>productMasterList,int start){
        ...
        try{
            ...
            for (int i = 0; i <productMasterList.size() ; i++){
                ...
                def purchaseAccountCodeDetails = new CoreParamsHelper().getChartMasterInformationByCode(productMaster.purchaseAccountCode)
                purchaseAccountCodeDetails=purchaseAccountCodeDetails[0]+"-"+purchaseAccountCodeDetails[1]
                def salesAccountCodeDetails = new CoreParamsHelper().getChartMasterInformationByCode(productMaster.salesAccountCode)
                salesAccountCodeDetails=salesAccountCodeDetails[0]+"-"+salesAccountCodeDetails[1]
                def status=new CoreParamsHelper().ShowStatus(productMaster.status)
    ...
    public List wrapProductUnitInGrid(List<GroovyRowResult>productUnitList,int start){
        ...
        try{
            ...
            for (int i = 0; i <productUnitList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(productUnit.status)
    ...
    public List wrapChartClassInGrid(List<GroovyRowResult>chartClassList,int start){
        ...
        try{
            ...
            for (int i = 0; i <chartClassList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(chartClass.status)
                changeBooking = "<a href='/chartClass/edit?id=${chartClass.id} '><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
    ...
    public List wrapChartGroupInGrid(List<GroovyRowResult>chartGroupList,int start){
        ...
        try{
            ...
            for (int i = 0; i <chartGroupList.size() ; i++){
                ...
                def status=new CoreParamsHelper().ShowStatus(chartGroup.status)
                changeBooking = "<a href='javascript:changeBooking(\"${chartGroup.id}\")'><img width=\"16\" height=\"15\" alt=\"Edit\" src=\"${contextPath}/images/edit.png\"></a>"
